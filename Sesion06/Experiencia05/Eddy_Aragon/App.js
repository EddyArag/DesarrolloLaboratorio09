...
import Api from './Api'; // Importamos el nuevo componente Api.js
        ...
        return (
            <div className="AppContainer max-w-4xl mx-auto p-8">
                <h1 className="text-4xl font-extrabold text-indigo-700 mb-6 border-b pb-2">
                    Práctica 05: Extracción de Datos
                </h1>
                
                {/* Componente que utiliza el estado local (Práctica 4) */}
                ...
                {/* Componente que utiliza el ciclo de vida para FETCH (Práctica 5) */}
                <Api />
